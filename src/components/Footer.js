        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col l3 s12">
              ...
              <ul>
                <li><a className="white-text" href="mailto:abs4real16.ma@gmail.com"><i className="material-icons">email</i></a></li>
              </ul>
            </div>
          </div>
        </div>
